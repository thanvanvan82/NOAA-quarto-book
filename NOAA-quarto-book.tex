...
You can also embed plots and reference them, like so Figure~\ref{fig-p}.

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{content/figures_and_tables_files/figure-pdf/fig-p-1.pdf}}

}

\caption{\label{fig-p}Plot of pressure}
